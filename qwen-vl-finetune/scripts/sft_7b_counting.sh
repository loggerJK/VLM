...
# Counting task LoRA fine-tuning for Qwen2.5-VL-7B
# Dataset: heez/pixmo-point-count-gen-und (understanding split)
...
torchrun --nproc_per_node=${NUM_GPUS} \
    ...
    --output_dir ./output/counting \
    --run_name qwen2vl-counting-lora \
    --report_to wandb
