OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step3500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step4000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step4500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step5000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step5500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step6000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="./evaluation_results/lora128_spatial_relation_wohead_und-20260126-144357/blink/step6500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=1 python evaluate_blink_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
