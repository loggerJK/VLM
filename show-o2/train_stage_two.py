...
def main():
    ...
    dataset_mmu = MMUDataset(
        ...
        default_system_prompt=dataset_config.default_system_prompt,
        is_clip_encoder=dataset_config.is_clip_encoder,
        text_tokenizer=text_tokenizer,
        image_size=preproc_config.resolution,
        max_seq_len=preproc_config.max_seq_length,
    ...
    train_dataloader_mmu = create_dataloader(dataset_mmu, config.training.batch_size_mmu, dataset_mmu.collate_fn)
    config.training.max_train_steps = len(dataset_mmu) // (
