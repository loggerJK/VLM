...
export WANDB_NAME="train[transformer_ONLY]_dset[pixmo-points_0-20]_ngpu1_bs1_accum128_lr5e-5"
...
accelerate launch \
    ...
    config=configs/showo2_7b_stage_2_counting_transformer_ONLY_dset[pixmo-points_0-20].yaml 
