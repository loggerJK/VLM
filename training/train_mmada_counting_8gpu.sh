#!/bin/bash
# MMaDA Counting Training — 1 node × 8 GPUs (DeepSpeed ZeRO-2)
#
# Run from the repository root:
#   bash training/train_mmada_counting_8gpu.sh
#
# All training params come from configs/mmada_counting_llada_instruct.yaml
...
#   OUTPUT_DIR=output/counting_lr1e-5 \
#   bash training/train_mmada_counting_8gpu.sh
#
#   # 3) Use 4 GPUs
...
#   RESUME=1 OUTPUT_DIR=output/counting_lr1e-5 \
#   bash training/train_mmada_counting_8gpu.sh
...
echo "========================================"
echo "MMaDA Counting training (8 GPU)"
