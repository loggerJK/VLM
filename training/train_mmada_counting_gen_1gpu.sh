#!/bin/bash
# MMaDA Counting-Gen Training — Single GPU (smoke test)
#
# Run from the repository root:
#   bash training/train_mmada_counting_gen_1gpu.sh
#
# Defaults: 100 train steps, eval every 50 steps. All training params
# come from configs/mmada_counting_gen_llada_instruct.yaml unless overridden.
#
# Override via env vars, e.g.:
#   MAX_TRAIN_STEPS=200 EVAL_EVERY=50 OUTPUT_DIR=output/counting_gen_smoke \
#   bash training/train_mmada_counting_gen_1gpu.sh
...
echo "========================================"
echo "MMaDA Counting-Gen training (1 GPU smoke test)"
