...
task="pointing"
max_seq_len=2048
exp_name="lora128_${task}_qaFixed_valPoint"
...
python -m torch.distributed.run --nproc_per_node=${n_gpus} --master_port=29506 train/train_pointing.py \
