#!/bin/bash
# position understanding training — 1 GPU NO_SHARD + LoRA (rank 128)
...
echo "============================================================"
echo " BAGEL — position und + LoRA (${NGPUS} GPUs)"
