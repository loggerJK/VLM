#!/bin/bash
# OCR synthetic understanding training — 1 GPU NO_SHARD + LoRA (rank 128)
#
...
TOTAL_STEPS=50000
SAVE_EVERY=2000
EXP_NAME=ocr_synthetic_und_lora_1gpu
EFFECTIVE_BATCH=128
NGPUS=1
...
echo "============================================================"
echo " BAGEL — ocr_synthetic und + LoRA (1 GPU)"
