...
# Configuration
INPUT_PATH = "data/pixmo-point-count-concat_0-20-qaFixed-final"
OUTPUT_PATH = "data/pixmo-point-count-concat_0-20-qaFixed-v5"
NUM_PROC = 64
...
def regenerate_qa(label, count, points):
