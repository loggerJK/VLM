#!/bin/bash
# OCR synthetic generation training — 1 GPU NO_SHARD + LoRA (rank 128)
#
...
echo "============================================================"
echo " BAGEL — ocr_synthetic gen + LoRA (${NGPUS} GPUs)"
