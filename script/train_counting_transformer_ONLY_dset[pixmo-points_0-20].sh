...
export WANDB_NAME="train[transformer_ONLY]_dset[pixmo-points_0-20]_ngpu1_bs1_accum128_lr4e-5_ep3_full"
NUM_GPUS=1
...
DATA_PATH="./data/pixmo-points-filtered_0-20_imgContained/train"
