...
# -----------------------------------------------------------------------------
# Janus-Pro-7B OCR Generation Training Script
# -----------------------------------------------------------------------------
# Usage:
#   bash script/train_ocr_gen_transformer_lora128.sh
#   bash script/train_ocr_gen_transformer_lora128.sh ./checkpoints/.../step-500  # resume
# -----------------------------------------------------------------------------
...
export WANDB_NAME="train[transformer_lora128]_task[ocr]_mode[gen]"
...
# Task-specific args
TASK_ARGS="--task $TASK --mode $MODE --ocr_num_samples $OCR_NUM_SAMPLES --ocr_image_width $OCR_IMAGE_WIDTH --gen_img_size $GEN_IMG_SIZE"
...
echo "Gen Image Size   : $GEN_IMG_SIZE"
