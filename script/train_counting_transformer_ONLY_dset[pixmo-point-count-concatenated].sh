...
export WANDB_NAME="train[transformer_ONLY]_dset[pixmo-point-count-concatenated]_ngpu2_bs1_accum64_lr4e-5_ep3_full"
NUM_GPUS=2
...
DATA_PATH="./data/pixmo-point-count-concatenated-dataset-qaFixed/train"
