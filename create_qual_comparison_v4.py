...
# FINAL Master Metadata provided by user
METADATA_FILE = "/mnt/data1/jiwon/evaluation_metadata_count.jsonl"
...
with open(METADATA_FILE, 'r') as f:
    for line in f:
        ...
        # Use 'prompt' key from the provided metadata format
        prompts.append(data['prompt'])

print(f"Loaded {len(prompts)} prompts from {METADATA_FILE}")
