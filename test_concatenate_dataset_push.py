...
combined_dataset_filtered = load_from_disk(save_path)

print ("Pushing to Hub...")
combined_dataset_filtered.push_to_hub("Jiwon-Kang/pixmo-point-count-concatenated-dataset-qaFixed", split="train")
