...
echo "========================================"
echo "Running baseline OCR generation evaluation "
echo "========================================"

torchrun --nproc_per_node=$NGPUS \
    evaluation_scripts/ocr_synthetic/generation/evaluate_ocr_generation_detailed_textfile.py \
    --model_path ${model_path} \
    --output_dir ${base_dir}/dvlm/janus/ocr_synthetic/generation_detailed_textfile/baseline \
    --cfg_weight 5.0 \
    --img_size 384 \
...
for ckpt in "${ckpt_list[@]}"; do
    echo "========================================"
    echo "Running baseline OCR generation evaluation for: $ckpt"
    echo "========================================"
    ...
    torchrun --nproc_per_node=$NGPUS \
        ...
        --output_dir ${base_dir}/dvlm/janus/ocr_synthetic/generation_detailed_textfile/${ckpt} \
        --cfg_weight 5.0 \
        --img_size 384 \
        --num_samples ${NUM_SAMPLES} \
        --ocr_model_path zai-org/GLM-OCR
