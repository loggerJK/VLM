...
torchrun --nproc_per_node=$NGPUS \
    ...
    --output_dir ${base_dir}/dvlm/lumina/ocr_synthetic/generation_detailed_textfile/baseline \
    --timesteps 64 \
    --cfg_scale 4.0 \
    --height 1024 \
    --width 1024 \
...
for ckpt in "${ckpt_list[@]}"; do
    ...
    torchrun --nproc_per_node=$NGPUS \
        ...
        --output_dir ${base_dir}/dvlm/lumina/ocr_synthetic/generation_detailed_textfile/${ckpt} \
        --timesteps 64 \
        --cfg_scale 4.0 \
        --height 1024 \
        --width 1024 \
