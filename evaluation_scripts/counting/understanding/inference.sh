...
output_base="${base_dir}/dvlm/blip3o/counting/understanding"
...
# ─────────────────────────────────────────────────────────────────────────────
# echo "========================================"
# echo "Running baseline Qwen2.5-VL counting understanding"
...
for ckpt in "${ckpt_list[@]}"; do
    echo "========================================"
    echo "Running counting understanding for checkpoint: $ckpt"
...
echo "All understanding checkpoints finished."
...
echo "All generation checkpoints finished."
