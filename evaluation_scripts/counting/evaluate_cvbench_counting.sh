OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step3500"
mkdir -p "$OUTPUT_DIR"
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step4000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step4500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step5000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step5500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step6000"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
...
OUTPUT_DIR="/mnt/data1/dvlm/counting/understanding/cvbench/step6500"
mkdir -p "$OUTPUT_DIR"
CUDA_VISIBLE_DEVICES=0 python evaluate_cvbench_spatial.py \
    --checkpoint Alpha-VLLM/Lumina-DiMOO \
    --vae_ckpt Alpha-VLLM/Lumina-DiMOO \
