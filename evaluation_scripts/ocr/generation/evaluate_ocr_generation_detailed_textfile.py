# -*- coding: utf-8 -*-
"""
OCR Generation Evaluation Script (Multi-GPU, 2-Stage) — Janus — Text File Prompts
...
def main():
    parser = argparse.ArgumentParser(description="OCR Generation Evaluation — Text File Prompts (Janus)")
    ...
    for i, answer_gt in tqdm(enumerate(prompts), total=total_samples, desc=f"Rank {rank} Stage1"):
        ...
        prompt_text = (
            f"A Mathpix Markdown  with sharp, legible black text. "
